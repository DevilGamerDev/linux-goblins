            ...
            <body>
                <div class="main">
                    <div class="flex justify-start items-center flex-col text-center px-10">
                        ...
                        <h1 class="text-8xl font-bold mt-8 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400" style={styles.padding}>Create A
                        ...
                        <h2 class="w-4/12 text-xl leading-8 text-neutral-500 tracking-wide mt-10">Linux Goblin is the #1 leading tool to build a beauty on a budget.</h2>
